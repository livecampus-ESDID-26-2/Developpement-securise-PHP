<?php
/**
 * Vue: Historique global pour admin
 */
?>
<!DOCTYPE html>
<html lang="fr">
    ...
    <div class="container">
        ...
        <div class="stats-bar">
            <div class="stat-item">
                ...
                <span class="stat-value"><?php echo count($transactions); ?></span>
            </div>
        ...
        <div class="historique-complet">
            <?php foreach ($transactions as $transaction): 
                $transaction_user = $users_map[$transaction['user_id']] ?? null;
            ?>
            <div class="transaction-detail">
                <div class="transaction-detail-header">
                    <div class="header-left">
                        ...
                        <?php if ($transaction_user): ?>
                        <span class="user-badge">
                            👤 <?php echo htmlspecialchars($transaction_user['email']); ?>
                        </span>
                        <?php endif; ?>
                    </div>
                    <div class="header-right">
